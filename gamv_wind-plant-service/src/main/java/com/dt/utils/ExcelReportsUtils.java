...
public class ExcelReportsUtils {
    ...
    public static void addCell(XSSFWorkbook workbook, XSSFRow row, XSSFSheet spreadsheet,
        ...
        try {
            ...
            log.error("Exception in addCell(XSSFWorkbook, XSSFRow, XSSFSheet, ColumnIndex, CellValue, Bold) ->" + e);
        }
    }
    ...
    public static void addTitleRow(XSSFWorkbook workbook, XSSFSheet spreadsheet,
        ...
        try {
            ...
            log.error("Exception in addTitleRow(XSSFWorkbook, XSSFSheet, CellRangeAddress, title) ->" + e);
        }
    }
    ...
    public static String getExcelTitle(String str1, String str2) {
        ...
        try {
            ...
            if (Utils.isNotEmpty(str1)) {
                title +=
                                str1 + StringConstants.SPACE + StringConstants.HYPHEN + StringConstants.SPACE;
            }
            if (Utils.isNotEmpty(str2)) {
                title += Utils.getValidString(
                                str2) + StringConstants.SPACE + StringConstants.HYPHEN + StringConstants.SPACE;
            }
    ...
    public static void copyRow(XSSFSheet p_sheet, int p_sourceRowNum, int p_targetRowNum) {
        ...
        try {
            ...
            log.error("Exception copyRow(XSSFSheet p_sheet, int p_sourceRowNum, int p_targetRowNum) ->" + e);
        }
    }
    ...
    public static XSSFRow getCopyRow(XSSFSheet sheet, int sourceRowIndex, int targetRowIndex) {
        ...
        try {
            ...
            log.error("Exception getCopyRow(XSSFSheet sheet, int sourceRowIndex, int targetRowIndex) ->" + e);
            return null;
        }
    }
    ...
    public static XSSFRow getCopyRow(XSSFSheet sourceSheet, XSSFSheet tagetSheet,
        ...
        try {
            ...
            log.error("Exception getCopyRow(XSSFSheet sheet, XSSFSheet tagetSheet, int sourceRowIndex, int targetRowIndex) ->" + e);
            return null;
        }
    }
    ...
    public static void addFormStatusCellValue(XSSFRow row, int columnIndex, String cellValue) {
        ...
        try {
            ...
            log.error("Exception in addFormStatusCellValue(XSSFRow row, int columnIndex, String cellValue) ->" + e);
        }
    }
    ...
    public static void addCellValue(XSSFRow row, int columnIndex, String cellValue) {
        ...
        try {
            ...
            log.error("Exception in addCellValue(XSSFRow row, int columnIndex, String cellValue) ->" + e);
        }
    }
    ...
    public static void merge(XSSFSheet spreadsheet, CellRangeAddress range, String value) {
        ...
        try {
            ...
            log.error("Exception in merge(XSSFSheet spreadsheet, CellRangeAddress range, String value) ->" + e);
        }
    }
    ...
    public static XSSFCell copyCell(XSSFSheet p_sheet, int p_sourceRowNum, int p_targetRowNum,
        ...
        try {
            ...
            log.error("Exception copyCell(p_sheet, p_sourceRowNum, p_targetRowNum, p_sourceCellNum, p_targetCellNum) ->" + e);
            return null;
        }
    }
            ...
            switch (CellType.valueOf(type)) {
                ...
                case NUMERIC:
                    ...
                    if (obj instanceof Date) {
                        value = LocalDateTimeUtils.convertLdtToDateString(
                                        LocalDateTimeUtils.convertDateToLdt(
