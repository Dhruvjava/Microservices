    ...
    private static String getMessageStr(String str) {
        ...
        for (String message : strArr) {
            if (Utils.isEmpty(msg)) {
                ...
                msg += StringConstants.SPACE + ErrorBundles.getProperty(
                                message) + StringConstants.COMMA;
            }
        }
    ...
    private static ErrorRs populateReportInputErrorRs(String errorCode) {
        ...
        if (Utils.isNotEmpty(errorCode)) {
            ...
            if (errorCodeStr.size() == 2) {
                ...
                errorRs.setMessage(
                                key + StringConstants.SPACE + StringConstants.HYPHEN + StringConstants.SPACE + ErrorBundles.getProperty(
                                                code));
            }
        }
        return errorRs;
